...
using Udemy_FinalCSharp_Sales3.Models.Enums;

namespace Udemy_FinalCSharp_Sales3.Data
{
    public class SeedingService
    {
        private Udemy_FinalCSharp_Sales3Context _context;

        public SeedingService(Udemy_FinalCSharp_Sales3Context context)
        {
            _context = context;
        }
